		...
		case 1: // edit state
			...
			else if (keys & KEY_A)
			{
				...
				else if (select == 2)
				{
					...
					case 2:
						Breathing_R = !Breathing_R;
						break;
					case 3:
						Breathing_G = !Breathing_G;
						break;
					case 4:
						Breathing_B = !Breathing_B;
						break;
					case 5:
						SD_R = !SD_R;
						break;
...
void save_set2_info(void)
{
	...
	u16 led_status = (led_open_sel << 7) | (Breathing_R << 5) | (Breathing_G << 4) | (Breathing_B << 3) | (SD_R << 2) |
	                 (SD_G << 1) | (SD_B);
